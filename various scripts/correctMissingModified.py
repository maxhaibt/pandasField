...
missmodifiedDF = targetDF[targetDF['modified'].isnull()]

print('length of missmodifiedDF: ', len(missmodifiedDF))

missmodifiedDF = missmodifiedDF.apply(addModifiedEntry, axis=1)
missmodifiedDF = DFtoDOC(missmodifiedDF, docfields)
print(json.dumps(missmodifiedDF, indent=4))


bulkSaveChanges(db_url, auth, db_name, missmodifiedDF)
